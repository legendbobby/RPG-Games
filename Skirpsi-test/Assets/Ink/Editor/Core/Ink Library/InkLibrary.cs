...
namespace Ink.UnityIntegration {
	...
	public class InkLibrary : ScriptableObject, IEnumerable<InkFile> {
        ...
        private static void BuildIncludeHierarchyAsIfMasterFile(InkFile potentialMasterInkFile, InkFile currentInkFile, Dictionary<InkFile, List<InkFile>> recursiveIncludeLogs)
        {
            ...
            InkFile FindIncludedFile(string masterFilePath, string includePath)
            {
